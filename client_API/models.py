...
class Manager(AbstractUser):
    ...
    email = models.EmailField(verbose_name='Email', null=True, unique=True)  # , db_index=True, null=True, unique=True)
    password = models.CharField(verbose_name='Пароль', max_length=88, blank=False)
